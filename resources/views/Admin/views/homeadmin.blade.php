...
">
    <div class="d-flex justify-content-left">
       ...
       <a href="{{route('gestioncomptes')}}"> <div class="card mb-3 mr-3 mt-4 custom-background" style="width: 300px;color:#ffffff;margin-right: 20px;">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="card-title" style="color: #ede8e8"><a href="{{route('gestioncomptes')}}" class="{{ Request::is('emploi') ? 'active' : '' }}" style="color: #ede8e8;text-decoration:none;">Gestion des comptes</a></h5>
