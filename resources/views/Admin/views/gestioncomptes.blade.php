                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('creationcomptes') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="password" name="mot_passe" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" style="background-color: #173165;">Enregistrer</button>
                    </form>
                </div>
            </div>
        </div>
