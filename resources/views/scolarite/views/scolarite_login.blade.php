        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                ...
                <div class="card custom-background custom-rounded p-3">
                    ...
                    <div class="card-body">
                        <form id="loginForm" action="{{ route('login.scolarite.submit') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="nom-d'utilisateur" class="text-color">Nom d'utilisateur</label>
                                <input type="text" class="form-control" id="nom-d'utilisateur" placeholder=" Entrer votre Nom " name="mail" value="{{ old('mail') }}" required autocomplete="mail" autofocus required >
                                @error('mail')
