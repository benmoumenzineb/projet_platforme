    ...
    <form action="{{ route('exams.store') }}" method="POST">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <label for="somme" class="form-label"><strong>Etablissement:</strong></label>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <label for="N_passeport" class="form-label"><strong>Groupe:</strong></label>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <label for="N_passeport" class="form-label"><strong>Niveau:</strong></label>
                    </div>
                    <div class="col-md-6">
                        <input type="time" class="form-control" name="heure_exam" id="heure_exam" placeholder="De ... à ...." required>
                    </div>
