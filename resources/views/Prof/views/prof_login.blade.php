...
<body class=" text-color">
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <img class="m-0 p-0 mt-0 img-logo mx-auto d-block" src="{{ asset('asset/images/logo.webp') }}" alt="suptech logo" width="55%">
                ...
                <div class="card custom-background custom-rounded p-3">
                    ...
                    <div class="card-body">
                        <form id="loginForm" action="{{ route('login.prof.submit') }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="nom-d'utilisateur" class="text-color">Nom d'utilisateur</label>
                                <input type="text" class="form-control" id="nom-d'utilisateur" placeholder=" Entrer votre Nom " name="matricule_cnss" value="{{ old('matricule_cnss') }}" required autocomplete="mail" autofocus required >
                                @error('matricule_cnss')
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="cin_salarie" class="form-control" id="password" required autocomplete="current-password" placeholder=" Entrer votre Mot de passe " required>
                                @error('cin_salarie')
