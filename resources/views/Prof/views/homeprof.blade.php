    ...
    <div class="d-flex justify-content-left">
       <a href="{{ route('Profil_etudiant') }}"> <div class="card mb-3 mr-3 mt-4  custom-background" style="width: 300px;color:#ffffff; margin-right: 20px;"style="color: #ffffff;">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="card-title" style="color: #ede8e8"> <a href="{{ route('Profil_etudiant') }}" style="color: #ede8e8; text-decoration:none;">Présence</a></h5>
       ...
       <a href="{{route('emploi')}}"> <div class="card mb-3 mr-3 mt-4 custom-background" style="width: 300px;color:#ffffff;margin-right: 20px;">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="card-title" style="color: #ede8e8"><a href="{{route('emploi')}}" class="{{ Request::is('emploi') ? 'active' : '' }}" style="color: #ede8e8;text-decoration:none;">Cahier De Texte</a></h5>
