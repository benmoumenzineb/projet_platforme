...
.th-color{
    ...
    <div id="identifiants-etudiant-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
        <div class="content" style="margin-left: 300px; margin-top:20px; overflow: hidden;">
            <fieldset class="border p-3">
                <legend  class="w-auto" style="font-size: 16px; color:#173165"><strong> Identifiants étudiant</strong></legend>
            ...
            <form id="identifiants_etudiant">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="Code_National" class="form-label"><strong>Code National de l'Etudiant(CNE) :</strong></label>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="date_inscription" class="form-label"><strong>Date d'inscription :</strong></label>
                            </div>
                            <div class="col-md-6">
    ...
    <div id="renseignements-etudiant-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
        <div class="content" style="margin-left: 300px; margin-top:20px; overflow: hidden;">
            <fieldset class="border p-3">
                <legend  class="w-auto" style="font-size: 16px; color:#173165"><strong> Renseignements étudiant</strong></legend>
            <form id="renseignements_etudiant">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="N_passeport" class="form-label"><strong>N° Passeport (Pour les étrangers) :</strong></label>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="N_passeport" name="N_passeport" required>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="handicap_oui" name="handicap_oui" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<div id="informations-parents-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
    <div class="content" style="margin-left: 300px; margin-top:20px; overflow: hidden;">
        <fieldset class="border p-3">
            <legend  class="w-auto" style="font-size: 16px; color:#173165"><strong> Informations parents</strong></legend>
        <form id="informations-parents">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="Profession_pere" class="form-label"><strong>Profession pére :</strong></label>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="persone_urgence" name="persone_urgence" required>
                        </div>
                    </div>
                </div>
...
<div class="modifier-content" style="margin-top: 20px; overflow: hidden;">
    <div class="row justify-content-end">
        <div class="col-md-6">
            <div class="d-flex justify-content-end">
                <button type="submit" id="modifier" name="modifier" class="btn btn-primary" style="background-color: #173165;border:none;">Modifier</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="renseignement-academique-baccalaureat-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                    ...
                    <fieldset class="border p-3">
                    <legend  class="w-auto" style="font-size: 16px; color:#173165"><strong> Baccalauréat</strong></legend>
    ...
    <!-- cursus externe-->
    <div id="renseignement-academique-cursus-externe-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
        <div class="content" style="margin-left: 300px; margin-top: 20px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                        ...
                        <fieldset class="border p-3">
                        <legend  class="w-auto" style="font-size: 16px; color:#173165"><strong>Cursus Externe</strong></legend>
        ...
        <div id="renseignement-academique-cursus-interne-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
            <div class="content" style="margin-left: 300px; margin-top: 20px;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                            ...
                            <fieldset class="border p-3">
                            <legend  class="w-auto" style="font-size: 16px; color:#173165"><strong>Cursus Interne</strong></legend>
                        <table class="table" id="renseignement-academique" >
                            <!-- Entête du tableau -->
                            <thead>
                                <!-- Entête du tableau -->
            ...
            <!--bourse-->
            <div id="renseignement-academique-bourse-content" class="content" style="margin-left: -20px; margin-top:20px; overflow: hidden;">
                <div class="content" style="margin-left: 300px; margin-top: 20px;">
