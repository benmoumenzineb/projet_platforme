    ...
    <div class="d-flex justify-content-left">
       ...
       <a href="{{route('reclamation')}}"> <div class="card mb-3 mr-3 mt-4 custom-background" style="width: 300px;color:#ffffff;margin-right: 20px;">
            ...
            <div class="card-body text-center">
                ...
                <h5 class="card-title" style="color: #ede8e8">  <a href="{{route('reclamation')}}" class="{{ Request::is('reclamation') ? 'active' : '' }}" style="color: #ede8e8;text-decoration:none;">Mes Réclamations</a></h5>
      ...
      <a href="{{ route('note') }}" > <div class="card mb-3 mr-3 custom-background" style="width: 300px;color:#ffffff;margin-right: 20px;">
           ...
           <a href="{{ route('demande') }}" ><div class="card mb-3 mr-3 custom-background" style="width: 300px;color:#ffffff;margin-right: 20px;">
                ...
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title" style="color: #ede8e8"><a href="{{ route('demande') }}" class="{{ Request::is('demande') ? 'active' : '' }}" style="color: #ede8e8;text-decoration:none;">Mes Demandes</a></h5>
                    
                </div>
            </div></a>
           <a href="{{ route('exam') }}"> <div class="card mb-3 mr-3 custom-background" style="width: 300px;
            color:#ffffff;margin-right: 20px;">
                ...
                <div class="card-body text-center">
                    ...
                    <h5 class="card-title" style="color: #ede8e8" ><a href="{{ route('exam') }}" style="color: #ede8e8;text-decoration:none;"> Mes Exames</a></h5>
